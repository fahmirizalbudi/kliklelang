...
@section('content')
  ...
  @endphp
  <section class="profil-pengguna">
    <div class="profil-pengguna-inner">
      <form action="{{ route('auth.masyarakat.update', $masyarakat) }}" method="POST" class="masyarakat-form">
        @csrf
        @method('PUT')
...
@push('styles')
  <link rel="stylesheet" href="{{ asset('css/pages/profile/masyarakat/style.css') }}">
